  ...
  render: function() {
    return(
      React.createElement("div", {className: "selectMode"}, 
        ...
        React.createElement("img", {className: "circularPhoto", src: "KohApple-Circular.png"}), 
        React.createElement("h2", {className: "modeLabel"}, "photograher"), 
        React.createElement("img", {className: "circularPhoto", src: "KohCamera-Circular.png"}), 
