    ...
    return(
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "center"}, 
          React.createElement("a", {className: "button", href: "https://vote.nyuapps.com/", target: "_blank"}, React.createElement("i", {className: "fa fa-laptop"}, "undefinednbsp"), "View Website"), 
          React.createElement("a", {className: "button", href: "https://github.com/hackAD/nyu-vote", target: "_blank"}, React.createElement("i", {className: "fa fa-code"}, "undefinednbsp"), "Examine Code")
        )
      )
    )
  }
